    ...
    <div class="containPage">
        <div class="titlePage d-flex">
            ...
            <div class="ml-auto mt-1">
                <button class="btnAdd"><i class="fa-solid fa-mug-hot"></i> Thêm</button>
        ...
        <div class="contentPage">
            <div class="row ">
                ...
                <div class="col">
                    <div class="item">
                        <div class="leftItem">
                            <img src="../../../CupCoffee/cup2.png" alt="" class="imageItem">
                            <div class="numberCup">
                                <input type="button" class="btnquantity" value="+">
                                <input type="text" class="quantity" value="0">
                                <input type="button" class="btnquantity" value="-">
                ...
                <div class="col">
                    <div class="item">
                        <div class="leftItem">
                            <img src="../../../CupCoffee/cup3.png" alt="" class="imageItem">
                            <div class="numberCup">
                                <input type="button" class="btnquantity" value="+">
                                <input type="text" class="quantity" value="0">
                                <input type="button" class="btnquantity" value="-">
                ...
                <div class="col">
                    <div class="item">
                        <div class="leftItem">
                            <img src="../../../CupCoffee/cup4.png" alt="" class="imageItem">
                            <div class="numberCup">
                                <input type="button" class="btnquantity" value="+">
                                <input type="text" class="quantity" value="0">
                                <input type="button" class="btnquantity" value="-">
                ...
                <div class="col">
                    <div class="item">
                        <div class="leftItem">
                            <img src="../../../CupCoffee/cup5.png" alt="" class="imageItem">
                            <div class="numberCup">
                                <input type="button" class="btnquantity" value="+">
                                <input type="text" class="quantity" value="0">
                                <input type="button" class="btnquantity" value="-">
                ...
                <div class="col">
                    <div class="item">
                        <div class="leftItem">
                            <img src="../../../CupCoffee/cup6.png" alt="" class="imageItem">
                            <div class="numberCup">
                                <input type="button" class="btnquantity" value="+">
                                <input type="text" class="quantity" value="0">
                                <input type="button" class="btnquantity" value="-">
