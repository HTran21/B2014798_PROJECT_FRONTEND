<template>
    <div class="containPage" v-if="isLogin">
        ...
        <div class="contentPage">
            ...
            <h3 class="px-4 mt-2 mb-0">Đơn hàng</h3>
                ...
                <table class="table table-hover text-center">
                    ...
                    <tbody>
                        ...
                        <tr v-for="(order, index) in data" :key="index">
                            ...
                            <td><input class="inputDate" type="datetime-local" v-model="order.NgayGH"></td>
    ...
    <div v-else class="denied">
        <img class="d-flex mt-5 ml-auto mr-auto mb-5" src="../../../public/Illustration/denied.png" alt="">
...
const dashBoard = () => {
    axios.get('http://localhost:3000/customer/dashboard')
        .then(res => {
...
const handleAccess = (order) => {
    ...
    if (NgayGH.value === '') {
        ...
        axios.put('http://localhost:3000/order', { idStaff, idOrder, NgayGH })
            .then(res => {
                if (res.data.error) {
...
const handleDenied = (order) => {
    idOrder.value = order._id;
    axios.delete("http://localhost:3000/order/admin/" + idOrder.value)
        .then(res => {
            if (res.data.error) {
                toast.error(res.data.error)
            }
