                        ...
                        <div class="card loginForm">
                            <div class="row g-0">
                                <div class="col-md-6 col-lg-6 d-flex align-items-center">
                                    <div class="card-body p-4 p-lg-4 text-black">
                                        ...
                                        <form @submit.prevent="register" enctype="multipart/form-data">
                                            ...
                                            <div class="fw-normal pb-2 desLogin">Tạo tài khoản nhân viên cửa hàng</div>
                                            ...
                                            <div class="group">
                                                <label for="position"><i class="fa-solid fa-user-tie iconForm"></i></label>
                                                <select class="selectGroup" v-model="position" name="postion" id="position"
                                                    required>
                                ...
                                <div class="col-md-6 col-lg-6 d-none d-md-block m-auto">
                                    <img src="../../../public/Illustration/admin_illustration.png" alt="login form"
                                        class="imageLogin " />
                                </div>
                            </div>
                        </div>
...
const register = async () => {
    ...
    axios.post('http://localhost:3000/authentication/staff', formData)
        .then(res => {
